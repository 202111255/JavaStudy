...
public class PdsController {
    ...
    public String view(String seq, Model model) {
        ...
        model.addAttribute( "to", pdsDAO.boardView( to ) );
        return "board_view1";
    }
    ...
    public String write_ok(MultipartFile upload, HttpServletRequest request, Model model ) {
        ...
        if (!upload.isEmpty()) {
            try {
                ...
                upload.transferTo(new File("D:\\JAVA\\BEProjects\\board02\\src\\main\\resources\\static\\upload", filename));
    ...
    public String modify(String seq, Model model) {
        ...
        model.addAttribute( "to", pdsDAO.boardModify( to ) );
    ...
    public String delete(String seq, Model model) {
        ...
        model.addAttribute( "to", pdsDAO.boardDelete( to ) );
